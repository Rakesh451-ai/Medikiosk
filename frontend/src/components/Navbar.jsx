...
import { Stethoscope, UserCheck, ShieldAlert, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex items-center gap-2">
            <Link
              to="/kiosk"
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all duration-200 active:scale-95 ${isKiosk
            ...
            <Link
              to="/doctor"
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all duration-200 active:scale-95 ${isDoctor
                ? 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-sm shadow-blue-700/25 ring-2 ring-blue-400/40'
                : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/80'
                }`}
            >
